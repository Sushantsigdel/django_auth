...
AWS_SES_ACCESS_KEY_ID = getenv('AWS_ACCESS_KEY_ID')
AWS_SES_SECRET_ACCESS_KEY = getenv('AWS_SECRET_ACCESS_KEY')
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        ...
        'src.apps.auth.auth.CustomJWTAuthentication',
    ],
}
